...
export default function TripTypeSelector({ selected, onChange, counts }: TripTypeSelectorProps) {
  const baseBtn = "relative flex items-center gap-2 text-gray-700 pb-1 shrink-0";

  const selectedStyle =
    "font-bold after:absolute after:-bottom-1 after:left-0 after:h-[2px] after:w-full after:bg-[linear-gradient(90deg,#5de0e6,#004aad)]";
